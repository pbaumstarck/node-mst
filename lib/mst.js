...
// function: ulam
// Gives what offset from zero the 0-base position 'ix' would be in an Ulam spiral, which starts as:
//   4 <- 3 <- 2    .
//   |         /\   .
//   \/        |    .
//   5    0 -> 1    10
...
function ulam(ix) {
	...
	// Make the position relative to the ring, which starts at 'base - 2'
	ix -= (base - 2) * (base - 2);
	if (ix == 0) {
